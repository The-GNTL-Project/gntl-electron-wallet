...
<q-page class="create">
    ...
    <GntlField :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
        <q-input
            v-model="wallet.name"
            @keyup.enter="create"
        ...
        <GntlField :label="$t('fieldLabels.seedLanguage')">
            <q-select
        ...
        <GntlField :label="$t('fieldLabels.password')" optional>
            <q-input
