...
<q-page>
    <div class="q-mx-md import-wallet">
        ...
        <GntlField :label="$t('fieldLabels.newWalletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <GntlField :label="$t('fieldLabels.walletFile')" disable-hover :error="$v.wallet.path.$error">
            <q-input
                v-model="wallet.path"
        ...
        <GntlField :label="$t('fieldLabels.password')">
            <q-input
        ...
        <GntlField :label="$t('fieldLabels.confirmPassword')">
            <q-input
