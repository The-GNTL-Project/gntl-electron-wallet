export default {
    ...
    menuItems: {
        ...
        exit: "Saír da Carteira GUI GNTL",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "gntld não encontrado, utilizando nódulo remoto"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        gntlUnlockedBalance: "Saldo desbloqueado",
        gntlUnlockedShort: "Desbloqueado",
