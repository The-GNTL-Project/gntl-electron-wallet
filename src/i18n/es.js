export default {
    ...
    menuItems: {
        ...
        exit: "Cerrar la interfaz del monedero GNTL",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "gntld no encontrado, utilizando nodo remoto"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        gntlBalance: "Saldo",
        gntlExchangeBalance: "Saldo",
        gntlUnlockedBalance: "Saldo libre",
        gntlUnlockedShort: "Libre",
        ...
        serviceNodeRegistrationDescription: "Introduzca la orden {registerCommand} generada por el servicio (gntld) que se está intentado registrar como Nodo de Servicio usando la instrucción \"{prepareCommand}\"",
        spendKey: "Clave de gasto",
