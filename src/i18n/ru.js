export default {
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "Не найден файл gntld, используется удаленная нода"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        gntlBalance: "Баланс",
        gntlExchangeBalance: "Баланс",
        gntlUnlockedBalance: "Разблокированый баланс",
        gntlUnlockedShort: "Разблокировано",
