...
<div class="settings-exchange">
    <div class="row pl-sm">
        <GntlField class="col-4" :label="$t('fieldLabels.protocol')" disable>
            <q-input
        ...
        <GntlField class="col-8" :label="$t('fieldLabels.hostname')" disable>
            <q-input
    ...
    <div class="row pl-sm">
        <GntlField class="col-10" :label="$t('fieldLabels.endpoint')" disable>
            <q-input
        ...
        <GntlField class="col-2" :label="$t('fieldLabels.port')" disable>
            <q-input
