...
<div class="check-transaction">
    <div class="q-pa-md">
        ...
        <div>
            <GntlField :label="$t('fieldLabels.transactionId')" :error="$v.txid.$error">
            ...
            <GntlField class="q-mt-md" :label="$t('fieldLabels.address')" :error="$v.address.$error" optional>
            ...
            <GntlField class="q-mt-md" :label="$t('fieldLabels.message')" optional>
            ...
            <GntlField class="q-mt-md" :label="$t('fieldLabels.signature')" :error="$v.signature.$error">
        ...
        <div v-if="status.state.txid">
            ...
            <div class="q-mb-sm" v-if="status.state.received != null">
                ...
                <div><FormatGntl :amount="status.state.received" raw-value /></div>
            </div>
