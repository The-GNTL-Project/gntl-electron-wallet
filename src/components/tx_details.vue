            ...
            <div class="row justify-between" style="max-width: 768px">
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatGntl :amount="tx.amount" raw-value /></span></div>
                    </div>
                </div>
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><FormatGntl :amount="tx.fee" raw-value /></span></div>
                    </div>
                </div>
                    ...
                    <template v-if="out_destinations">
                        <q-item class="q-px-none" v-for="(destination, index) in out_destinations" :key="index">
                            <q-item-main>
                                ...
                                <q-item-tile sublabel><FormatGntl :amount="destination.amount" /></q-item-tile>
                            </q-item-main>
                            <q-context-menu>
                                <q-list link separator style="min-width: 150px; max-height: 300px;">
                                    <q-item v-close-overlay
